  ...
  return (
    <div className="mx-auto max-w-6xl px-6">
      ...
      <section className="relative flex flex-col items-center py-20 text-center sm:py-28">
        ...
        {/* Status badge */}
        <div className="relative mb-8 inline-flex items-center gap-2 rounded-full border border-accent-green/40 bg-accent-green/10 px-4 py-1.5 text-sm text-accent-green">
          <span className="inline-block h-2 w-2 rounded-full bg-accent-green animate-pulse-soft" />
          持续更新中
        </div>
